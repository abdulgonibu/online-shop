    ...
    <div class="content-header">
        ...
        <div class="leftside-content-header">
            <ul class="breadcrumbs">
                <li><i class="fa fa-home" aria-hidden="true"></i><a href="#">Sub Categories</a></li>
            </ul>
        </div>
    </div>
    <!-- =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= -->
            ...
            <div class="panel b-primary bt-md">
                <div class="panel-content">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <a href="{{ route('sub.category.create') }}" class="btn btn-primary pull-right">Add Sub Category</a>
                        </div>
                    </div>
